...
/****** Object: Table [dbo].[Fact_sales] Script Date: 4/14/2026 10:02:29 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[Fact_sales] WITH CHECK ADD CONSTRAINT [FK__Fact_sale__order__46E78A0C] FOREIGN KEY([ordertime_FK])
REFERENCES [dbo].[DimTime] ([TimeSK])
GO

ALTER TABLE [dbo].[Fact_sales] CHECK CONSTRAINT [FK__Fact_sale__order__46E78A0C]
GO
